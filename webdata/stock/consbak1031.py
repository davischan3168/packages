...
DOMAINS = {'sina': 'sina.com.cn', 'sinahq': 'sinajs.cn',
           ...
           'oss1': '218.244.146.57', 'idxip':'115.29.204.48',
           'shibor': 'www.shibor.org', 'mbox':'www.cbooo.cn',
           'tt': 'gtimg.cn','oss': 'file.tushare.org',
           'gw': 'gw.com.cn','v500': 'value500.com'}
...
KLINE_TT_URLL = '%sweb.ifzq.%s/appstock/app/%skline/get?_var=kline_day%s&param=%s,%s,%s,%s,640,%s&r=0.%s'
